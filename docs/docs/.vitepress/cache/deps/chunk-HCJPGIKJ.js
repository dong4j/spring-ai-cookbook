...
function reactify(fn, options) {
  const unrefFn = (
                      options == null ? void 0 : options.computedGetter) === false ? unref : toValue;
...
function reactiveOmit(obj, ...keys2) {
  ...
  return reactiveComputed(
      () => typeof predicate === "function" ? Object.fromEntries(Object.entries(toRefs(obj)).filter(([k, v]) => !predicate(toValue(v), k)))
...
function objectOmit(obj, keys2, omitUndefined = false) {
  return Object.fromEntries(Object.entries(obj).filter(([key, value]) => {
    return (
               !omitUndefined || value !== void 0) && !keys2.includes(key);
  }));
}
...
function refDefault(source, defaultValue) {
  return computed({
                    get() {
                      var _a;
                      return (
                                 _a = source.value) != null ? _a : defaultValue;
                    },
                    set(value) {
                      source.value = value;
                    }
...
function refWithControl(initial, options = {}) {
  ...
  function set2(value, triggering = true) {
    ...
    if ((
            (
                _a = options.onBeforeChange) == null ? void 0 : _a.call(options, value, old)) === false) {
      return;
    }
    source = value;
    (
...
function syncRef(left, right, ...[options]) {
  ...
  const watchers = [];
  const transformLTR = "ltr" in transform && transform.ltr || (
      (v) => v);
  const transformRTL = "rtl" in transform && transform.rtl || (
      (v) => v);
...
function useArrayDifference(...args) {
  ...
  const values = args[1];
  let compareFn = (
                      _a = args[2]) != null ? _a : defaultComparator;
  const {
    symmetric = false
  } = (
          _b = args[3]) != null ? _b : {};
...
function useArrayFindLast(list, fn) {
  return computed(() => toValue(
      !Array.prototype.findLast ? findLast(toValue(list), (element, index, array) => fn(toValue(element), index, array)) : toValue(list)
...
function useArrayIncludes(...args) {
  ...
  if (isArrayIncludesOptions(comparator)) {
    formIndex =
        (
            _a = comparator.fromIndex) != null ? _a : 0;
...
function useArrayReduce(list, reducer, ...args) {
  ...
  return computed(() => {
    ...
    return args.length ? resolved.reduce(reduceCallback, typeof args[0] === "function" ? toValue(args[0]()) : toValue(args[0]))
...
function formatDate(date, formatStr, options = {}) {
  ...
  const stripTimeZone = (dateString) => {
    var _a2;
    return (
               _a2 = dateString.split(" ")[1]) != null ? _a2 : "";
  };
  const matches = {
  ...
  return formatStr.replace(REGEX_FORMAT, (match, $1) => {
    ...
    return (
               _b =
           $1 != null ? $1 : (
                                 _a2 = matches[match]) == null ? void 0 : _a2.call(matches)) != null ? _b : match;
  });
}
...
function useLastChanged(source, options = {}) {
  var _a;
  const ms = shallowRef((
                            _a = options.initialValue) != null ? _a : null);
  watch(
      source,
      () => ms.value = timestamp(),
      options
...
function watchArray(source, cb, options) {
  let oldList = (
                    options == null ? void 0 : options.immediate) ? [] : [...typeof source === "function" ? source() : Array.isArray(source)
                                                                                                                       ? source : toValue(
          source)];
  ...
  const reuse = defineComponent({
                                  ...
                                  setup(props, {attrs, slots}) {
                                    return () => {
                                      ...
                                      const vnode = (
                                                        _a = render.value) == null ? void 0 : _a.call(render, {
                                        ...options.props == null ? keysToCamelKebabCase(attrs) : props,
                                        $slots: slots
                                      });
                                      return inheritAttrs && (
                                          vnode == null ? void 0 : vnode.length) === 1 ? vnode[0] : vnode;
                                    };
                                  }
                                });
...
function createTemplatePromise(options = {}) {
  ...
  const component = defineComponent((_, {slots}) => {
    const renderList = () => instances.value.map((props) => {
      var _a;
      return h(Fragment, {key: props.key}, (
...
function unrefElement(elRef) {
  ...
  return (
             _a = plain == null ? void 0 : plain.$el) != null ? _a : plain;
}
      ...
      () => {
        ...
        return [
          (
              _b =
                  (
                      _a = firstParamTargets.value) == null ? void 0 : _a.map((e) => unrefElement(e))) != null ? _b
...
function onClickOutside(target, handler, options = {}) {
  ...
  const shouldIgnore = (event) => {
    return toValue(ignore).some((target2) => {
      if (typeof target2 === "string") {
        return Array.from(window2.document.querySelectorAll(target2))
  ...
  const listener = (event) => {
    ...
    if (!(
        el instanceof Element) && hasMultipleRoots(target) && checkMultipleRoots(target, event)) {
      return;
    }
  ...
  const stopWatch = watchEffect(() => {
    ...
    if (el) {
      const {stop} = useMutationObserver(
          document2,
          (mutationsList) => {
            const targetRemoved = mutationsList.map((mutation) => [...mutation.removedNodes]).flat()
...
function onLongPress(target, handler, options) {
  ...
  function onRelease(ev) {
    ...
    clear();
    if (!(
        options == null ? void 0 : options.onMouseUp) || !_posStart || !_startTimestamp) {
      return;
    }
    if ((
            (
                _a2 = options == null ? void 0 : options.modifiers) == null ? void 0 : _a2.self) && ev.target !== elementRef.value) {
      return;
    }
    if ((
            _b2 = options == null ? void 0 : options.modifiers) == null ? void 0 : _b2.prevent) {
      ev.preventDefault();
    }
    if ((
            _c = options == null ? void 0 : options.modifiers) == null ? void 0 : _c.stop) {
      ev.stopPropagation();
    }
  ...
  const listenerOptions = {
    capture: (
                 _a = options == null ? void 0 : options.modifiers) == null ? void 0 : _a.capture,
    once: (
              _b = options == null ? void 0 : options.modifiers) == null ? void 0 : _b.once
  };
  const cleanup = [
    ...
    return {
      get() {
        ...
        return (
                   _b =
                       (
                           _a = instance == null ? void 0 : instance.proxy) == null ? void 0 : _a.$refs[key]) != null ? _b : initialValue;
      },
      set() {
      }
    };
...
function useAsyncQueue(tasks, options) {
  ...
  tasks.reduce((prev, curr) => {
    return prev.then((prevRes) => {
      ...
      if ((
              (
                  _a = result[activeIndex.value]) == null ? void 0 : _a.state) === promiseState.rejected && interrupt) {
        onFinished();
        return;
      }
...
function useBase64(target, options) {
  ...
  function execute() {
    ...
    promise.value.then((res) => {
      base64.value =
          (
              options == null ? void 0 : options.dataUrl) === false ? res.replace(/^data:.*?;base64,/, "") : res;
    });
...
function useBluetooth(options) {
  ...
  async function requestDevice() {
    ...
    try {
      device.value =
          await (
              navigator2 == null ? void 0 : navigator2.bluetooth.requestDevice({
                                                                                 acceptAllDevices,
                                                                                 filters,
                                                                                 optionalServices
                                                                               }));
...
function useBrowserLocation(options = {}) {
  ...
  for (const [key, ref2] of objectEntries(refs)) {
    watch(ref2, (value) => {
      if (!(
          window2 == null ? void 0 : window2.location) || window2.location[key] === value) {
        return;
      }
  ...
  const update = () => {
    ...
    state.value =
        (
            _b =
                (
                    _a = permissionStatus.value) == null ? void 0 : _a.state) != null ? _b : "prompt";
  };
    ...
    return (
               _c =
                   (
                       _b =
                   (
                       _a = document == null ? void 0 : document.getSelection) == null ? void 0 : _a.call(document)) == null ? void 0
                                                                                                                             : _b.toString()) !=
           null ? _c : "";
  }
...
function useCloned(source, options = {}) {
  ...
  if (!manual && (
      isRef(source) || typeof source === "function")) {
    watch(source, sync, {
      ...options,
      deep,
      immediate
...
function guessSerializerType(rawInit) {
  return rawInit == null ? "any" : rawInit instanceof Set ? "set" : rawInit instanceof Map ? "map" : rawInit instanceof Date ? "date"
                                                                                                                             : typeof rawInit ===
                                                                                                                               "boolean"
                                                                                                                               ? "boolean"
                                                                                                                               : typeof rawInit ===
...
function useStorage(key, defaults2, storage, options = {}) {
  ...
  const data = (
      shallow ? shallowRef : ref)(typeof defaults2 === "function" ? defaults2() : defaults2);
  ...
  if (!storage) {
    try {
      storage = getSSRHandler("getDefaultStorage", () => {
        var _a2;
        return (
                   _a2 = defaultWindow) == null ? void 0 : _a2.localStorage;
      })();
    } catch (e) {
      onError(e);
    }
...
function useColorMode(options = {}) {
  ...
  const store = storageRef || (
      storageKey == null ? toRef2(initialValue) : useStorage(storageKey, initialValue, storage, {window: window2, listenToStorageChanges}));
  const state = computed(() => store.value === "auto" ? system.value : store.value);
  const updateHTMLAttrs = getSSRHandler(
      "updateHTMLAttrs",
      (selector2, attribute2, value) => {
        const el = typeof selector2 === "string" ? window2 == null ? void 0 : window2.document.querySelector(selector2) : unrefElement(
            selector2);
        if (!el) {
          return;
        }
        ...
        if (attribute2 === "class") {
          ...
          Object.values(modes).flatMap((i) => (
              i || "").split(/\s/g)).filter(Boolean).forEach((v) => {
...
function useCssVar(prop, target, options = {}) {
  ...
  watch(
      ...
      ([val, el]) => {
        ...
        if ((
                el == null ? void 0 : el.style) && raw_prop) {
          if (val == null) {
...
function useCycleList(list, options) {
  ...
  const index = computed({
                           get() {
                             ...
                             let index2 = (
                                              options == null ? void 0 : options.getIndexOf) ? options.getIndexOf(state.value, targetList)
                                                                                             : targetList.indexOf(state.value);
                             if (index2 < 0) {
                               index2 =
                                   (
                                       _a = options == null ? void 0 : options.fallbackIndex) != null ? _a : 0;
                             }
                             return index2;
                           },
                           set(v) {
  ...
  function getInitialValue() {
    ...
    return (
               _b =
                   toValue((
               _a = options == null ? void 0 : options.initialValue) != null ? _a : toValue(list)[0])) != null ? _b : void 0;
  }
      ...
      const onDeviceMotion = createFilterWrapper(
          ...
          (event) => {
            ...
            acceleration.value = {
              x: (
                     (
                         _a = event.acceleration) == null ? void 0 : _a.x) || null,
              y: (
                     (
                         _b = event.acceleration) == null ? void 0 : _b.y) || null,
              z: (
                     (
                         _c = event.acceleration) == null ? void 0 : _c.z) || null
            };
            accelerationIncludingGravity.value = {
              x: (
                     (
                         _d = event.accelerationIncludingGravity) == null ? void 0 : _d.x) || null,
              y: (
                     (
                         _e = event.accelerationIncludingGravity) == null ? void 0 : _e.y) || null,
              z: (
                     (
                         _f = event.accelerationIncludingGravity) == null ? void 0 : _f.z) || null
            };
            rotationRate.value = {
              alpha: (
                         (
              ...
              beta: (
                        (
                            _h = event.rotationRate) == null ? void 0 : _h.beta) || null,
              gamma: (
                         (
...
function useDisplayMedia(options = {}) {
  ...
  const enabled = shallowRef((
                                 _a = options.enabled) != null ? _a : false);
  ...
  const isSupported = useSupported(() => {
    var _a2;
    return (
               _a2 = navigator2 == null ? void 0 : navigator2.mediaDevices) == null ? void 0 : _a2.getDisplayMedia;
  });
...
function useDraggable(target, options = {}) {
  ...
  const start = (e) => {
    ...
    if ((
            onStart == null ? void 0 : onStart(pos, e)) === false) {
      return;
    }
  ...
  if (isClient) {
    const config = () => {
      ...
      return {
        capture: (
                     _a2 = options.capture) != null ? _a2 : true,
...
function useDropZone(target, options = {}) {
  ...
  if (isClient) {
    ...
    const multiple = (
                         _a = _options.multiple) != null ? _a : true;
    ...
    const getFiles = (event) => {
      ...
      const list = Array.from((
                                  _b2 =
                                      (
                                          _a2 = event.dataTransfer) == null ? void 0 : _a2.files) != null ? _b2 : []);
    ...
    const checkDataTypes = (types) => {
      ...
      if (!(
          dataTypes == null ? void 0 : dataTypes.length)) {
        return true;
      }
      if (types.length === 0) {
        return false;
...
function useElementSize(target, initialSize = {width: 0, height: 0}, options = {}) {
  ...
  const isSVG = computed(() => {
    ...
    return (
               _b =
           (
               _a = unrefElement(target)) == null ? void 0 : _a.namespaceURI) == null ? void 0 : _b.includes("svg");
  });
  ...
  const {stop: stop1} = useResizeObserver(
      target,
      ([entry]) => {
        const boxSize = box === "border-box" ? entry.borderBoxSize : box === "content-box" ? entry.contentBoxSize
...
function useFetch(url, ...args) {
  ...
  const {
    fetch = (
                _a = defaultWindow) == null ? void 0 : _a.fetch,
    initialData,
    timeout
  } = options;
...
function useFileSystemAccess(options = {}) {
  ...
  const fileName = computed(() => {
    ...
    return (
               _b =
                   (
                       _a = file.value) == null ? void 0 : _a.name) != null ? _b : "";
  });
  const fileMIME = computed(() => {
    ...
    return (
               _b =
                   (
                       _a = file.value) == null ? void 0 : _a.type) != null ? _b : "";
  });
  const fileSize = computed(() => {
    ...
    return (
               _b =
                   (
                       _a = file.value) == null ? void 0 : _a.size) != null ? _b : 0;
  });
  const fileLastModified = computed(() => {
    ...
    return (
               _b =
                   (
                       _a = file.value) == null ? void 0 : _a.lastModified) != null ? _b : 0;
  });
  ...
  async function updateFile() {
    ...
    file.value =
        await (
            (
                _a = fileHandle.value) == null ? void 0 : _a.getFile());
  }
  ...
  async function updateData() {
    ...
    if (type === "Text") {
      data.value =
          await (
              (
                  _a = file.value) == null ? void 0 : _a.text());
    } else if (type === "ArrayBuffer") {
      data.value =
          await (
              (
                  _b = file.value) == null ? void 0 : _b.arrayBuffer());
    } else if (type === "Blob") {
  ...
  useEventListener(targetElement, "focus", (event) => {
    ...
    if (!focusVisible || (
        (
            _b =
                (
                    _a = event.target).matches) == null ? void 0 : _b.call(_a, ":focus-visible"))) {
        ...
        (
            _c =
                (
                    _b =
                (
                    _a = targetElement.value) == null ? void 0 : _a.matches) == null ? void 0 : _b.call(_a, PSEUDO_CLASS_FOCUS_WITHIN)) !=
        null ? _c : false;
  }, listenerOptions);
  return {focused};
}
...
function useFullscreen(target, options = {}) {
  ...
  const targetRef = computed(() => {
    var _a;
    return (
               _a = unrefElement(target)) != null ? _a : document2 == null ? void 0 : document2.documentElement;
  });
  ...
  const isSupported = useSupported(
      () => targetRef.value && document2 && requestMethod.value !== void 0 && exitMethod.value !== void 0 && fullscreenEnabled.value !==
            void 0);
  const isCurrentElementFullScreen = () => {
    if (fullscreenElementMethod) {
      return (
                 document2 == null ? void 0 : document2[fullscreenElementMethod]) === targetRef.value;
    }
    return false;
  };
  ...
  async function exit() {
    ...
    if (exitMethod.value) {
      if ((
              document2 == null ? void 0 : document2[exitMethod.value]) != null) {
        await document2[exitMethod.value]();
      } else {
        const target2 = targetRef.value;
        if ((
                target2 == null ? void 0 : target2[exitMethod.value]) != null) {
...
function useScroll(element, options = {}) {
  ...
  const setArrivedState = (target) => {
    ...
    const left = Math.abs(scrollLeft * directionMultipler) <= (
        offset.left || 0);
    const right = Math.abs(scrollLeft * directionMultipler) + el.clientWidth >= el.scrollWidth - (
        offset.right || 0) - ARRIVED_STATE_THRESHOLD_PIXELS;
    ...
    const top = Math.abs(scrollTop) <= (
        offset.top || 0);
    const bottom = Math.abs(scrollTop) + el.clientHeight >= el.scrollHeight - (
        offset.bottom || 0) - ARRIVED_STATE_THRESHOLD_PIXELS;
...
function useMagicKeys(options = {}) {
  ...
  function updateRefs(e, value) {
    var _a, _b;
    const key = (
                    _a = e.key) == null ? void 0 : _a.toLowerCase();
    const code = (
...
function useNow(options = {}) {
  ...
  const controls = interval === "requestAnimationFrame" ? useRafFn(update, {immediate: true}) : useIntervalFn(update, interval,
                                                                                                              {immediate: true});
  if (exposeControls) {
    return {
      now: now2,
...
function useParallax(target, options = {}) {
  ...
  const tilt = computed(() => {
    if (source.value === "deviceOrientation") {
      ...
      const value = (
                        x.value - width.value / 2) / width.value;
...
function usePointerLock(target, options = {}) {
  ...
  async function lock(e) {
    ...
    targetElement =
        e instanceof Event ? (
                                 _a = unrefElement(target)) != null ? _a : triggerElement.value : unrefElement(e);
    if (!targetElement) {
...
function usePointerSwipe(target, options = {}) {
  ...
  const eventIsAllowed = (e) => {
    ...
    return (
           ...
           (
               _b =
                   (
                       _a = options.pointerTypes) == null ? void 0 : _a.includes(e.pointerType)) != null ? _b : isReleasingButton ||
                                                                                                                isPrimaryButton) != null
           ? _c : true;
  };
  const listenerOptions = {passive: true};
  const stops = [
  ...
  tryOnMounted(() => {
    ...
    (
        _b =
    (
        _a = targetRef.value) == null ? void 0 : _a.style) == null ? void 0 : _b.setProperty("touch-action", "none");
    if (disableTextSelect) {
      (
          _d =
      (
          _c = targetRef.value) == null ? void 0 : _c.style) == null ? void 0 : _d.setProperty("-webkit-user-select", "none");
      (
          _f =
      (
          _e = targetRef.value) == null ? void 0 : _e.style) == null ? void 0 : _f.setProperty("-ms-user-select", "none");
      (
          _h =
      (
          _g = targetRef.value) == null ? void 0 : _g.style) == null ? void 0 : _h.setProperty("user-select", "none");
    }
  });
...
function checkOverflowScroll(ele) {
  ...
  if (style.overflowX === "scroll" || style.overflowY === "scroll" || style.overflowX === "auto" && ele.clientWidth < ele.scrollWidth ||
...
function useSorted(...args) {
  ...
  if (args.length === 2) {
    ...
    compareFn =
        (
            _c = args[1]) != null ? _c : defaultCompare;
    options =
        (
            _d = args[2]) != null ? _d : {};
  }
...
function useStorageAsync(key, initialValue, storage, options = {}) {
  ...
  const type = guessSerializerType(rawInit);
  const data = (
      shallow ? shallowRef : ref)(toValue(initialValue));
  const serializer = (
                         _a = options.serializer) != null ? _a : StorageSerializers[type];
  if (!storage) {
    try {
...
function useTextDirection(options = {}) {
  ...
  function getValue2() {
    ...
    return (
               _b =
                   (
                       _a = document2 == null ? void 0 : document2.querySelector(selector)) == null ? void 0 : _a.getAttribute("dir")) !=
           null ? _b : initialValue;
  }
...
function getRangesFromSelection(selection) {
  var _a;
  const rangeCount = (
                         _a = selection.rangeCount) != null ? _a : 0;
...
function useTextSelection(options = {}) {
  ...
  const text = computed(() => {
    ...
    return (
               _b =
                   (
                       _a = selection.value) == null ? void 0 : _a.toString()) != null ? _b : "";
  });
...
function useTextareaAutosize(options = {}) {
  ...
  watch(textareaScrollHeight, () => {
    var _a2;
    return (
               _a2 = options == null ? void 0 : options.onResize) == null ? void 0 : _a2.call(options);
  });
...
function useTitle(newTitle = null, options = {}) {
  ...
  const isReadonly2 = !!(
      newTitle && typeof newTitle === "function");
...
function executeTransition(source, from, to, options = {}) {
  ...
  const duration = (
                       _a = toValue(options.duration)) != null ? _a : 1e3;
  const startedAt = Date.now();
  const endAt = Date.now() + duration;
  const trans = typeof options.transition === "function" ? options.transition : (
                                                                                    _b = toValue(options.transition)) != null ? _b
                                                                                                                              : identity;
...
function useUserMedia(options = {}) {
  ...
  const isSupported = useSupported(() => {
    var _a2;
    return (
               _a2 = navigator2 == null ? void 0 : navigator2.mediaDevices) == null ? void 0 : _a2.getUserMedia;
  });
  const stream = shallowRef();
  ...
  const _emit = emit || (
      vm == null ? void 0 : vm.emit) || (
                    ...
                    (
                        _c =
                    (
                        _b = vm == null ? void 0 : vm.proxy) == null ? void 0 : _b.$emit) == null ? void 0 : _c.bind(
                        vm == null ? void 0 : vm.proxy));
  let event = eventName;
  if (!key) {
    key = "modelValue";
  }
...
function createCalculateRange(type, overscan, getOffset, getViewCapacity, {containerRef, state, currentList, source}) {
  return () => {
    ...
    if (element) {
      ...
      currentList.value =
          source.value.slice(state.value.start, state.value.end).map((ele, index) => (
              {
                data: ele,
...
function useWakeLock(options = {}) {
    ...
    useEventListener(sentinel, "release", () => {
      ...
      requestedType.value =
          (
              _b =
                  (
                      _a = sentinel.value) == null ? void 0 : _a.type) != null ? _b : false;
    }, {passive: true});
    whenever(
        () => documentVisibility.value === "visible" && (
            document2 == null ? void 0 : document2.visibilityState) === "visible" && requestedType.value,
        (type) => {
  ...
  async function forceRequest(type) {
    ...
    await (
        (
            _a = sentinel.value) == null ? void 0 : _a.release());
  ...
  const _init = () => {
    ...
    ws.onclose = (ev) => {
      ...
      if (!explicitlyClosed && options.autoReconnect && (
        ...
        const checkRetires = typeof retries === "function" ? retries : () => typeof retries === "number" && (
            retries < 0 || retried < retries);
